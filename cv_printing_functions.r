...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$softwareskills        <- read_gsheet(sheet_id = "software_skills")
  } else {
    ...
    cv$softwareskills <- readr::read_csv(paste0(data_location, "software_skills.csv"), skip = 1)
  }
...
#' @description Other Technical skills word print
